# Contributing — FirewallXPL-Forge
...
- **Catalogs:** updates under `firewallxpl/resources/catalogs/` with rationale and sources
...
If you add or remove Python modules under `firewallxpl/modules/`, also run:
