# Guia de contribuição — FirewallXPL-Forge
...
- **Catálogos:** `firewallxpl/resources/catalogs/` com justificativa e fontes
...
Ao adicionar/remover módulos em `firewallxpl/modules/`:
