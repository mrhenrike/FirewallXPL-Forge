...
from firewallxpl.core.exploit.module_target_scope import (
    ...
    def run(self):
        ...
        if self.vulnerabilities:
            ...
            print_info(
                "\033[91m[-]\033[0m",
                (
                    "{} During this AutoPwn run, no exploitable weakness was confirmed by the current FirewallXPL-Forge "
    ...
    def creds_target_function(self, running, data):
        ...
        while running.is_set():
            try:
                ...
                generic = False
                if exploit.__module__.startswith("firewallxpl.modules.creds.generic"):
