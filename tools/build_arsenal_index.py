...
def main() -> int:
    ...
    resources_root = repo_root / "firewallxpl" / "resources"
    ...
    index: Dict[str, object] = {
        "metadata": {
            ...
            "curated_layout_catalog": "firewallxpl/resources/catalogs/arsenal_layout.json",
        },
        ...
        "curated_arsenal": {
            "root": "firewallxpl/resources/arsenal",
