...
from firewallxpl.core.soho_exploit_catalog import index_catalog_script_functions, resolve_soho_catalog_root
...
def main() -> int:
    ...
    out_path = repo / "firewallxpl" / "resources" / "catalogs" / "soho_catalog_js_index.json"
