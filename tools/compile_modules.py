...
"""Byte-compile first-party FirewallXPL Python only.

Vendored trees under ``firewallxpl/resources/`` (PoC mirrors, MIBs, etc.) are **not**
compiled: many vendored exploits target Python 2 or are intentionally broken.

Use this in CI or pre-commit instead of ``python -m compileall firewallxpl``.
"""
