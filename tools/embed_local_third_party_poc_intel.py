...
* ``firewallxpl/resources/catalogs/embedded_third_party_poc_intel.json``
...
MARKET_JSON = RXFORGE_ROOT / "firewallxpl" / "resources" / "catalogs" / "market_priority_devices_2010_2026.json"
DISCORD_JSON = RXFORGE_ROOT / "firewallxpl" / "resources" / "catalogs" / "discord_requested_devices.json"
OUT_INTEL = RXFORGE_ROOT / "firewallxpl" / "resources" / "catalogs" / "embedded_third_party_poc_intel.json"
EXT_SOURCES = RXFORGE_ROOT / "firewallxpl" / "resources" / "catalogs" / "external_tool_intel_sources.json"
...
def _scan_repo_body(body_dir: Path, slug: str) -> dict[str, Any]:
    ...
    return {
        ...
        "rxforge_integration": (
            ...
            if slug in SKIP_EXPLOITDB_BODY
            else "local_upstream_mirror_under_firewallxpl_intel"
        ),
        "notes": (
