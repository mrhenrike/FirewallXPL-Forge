...
Copies each top-level directory to::
    ...
    firewallxpl/resources/arsenal/pocs/incorporated_third_party/<same_folder_name>/
...
_DST_ROOT = _RXFORGE / "firewallxpl" / "resources" / "arsenal" / "pocs" / "incorporated_third_party"
_INDEX_OUT = _RXFORGE / "firewallxpl" / "resources" / "catalogs" / "incorporated_third_party_index.json"
