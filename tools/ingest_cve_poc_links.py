...
FirewallXPL ``cve_extended_catalog.json`` (vendor/product/description) and optionally against
...
DEFAULT_TG12 = DEFAULT_SUPER / "submodules" / "IoT" / "fxf-poc-catalog" / "tg12__PoC_CVEs"
DEFAULT_CVE_CATALOG = RXFORGE_ROOT / "firewallxpl" / "resources" / "catalogs" / "cve_extended_catalog.json"
...
# Edge / FirewallXPL scope tokens (URL path, README metadata, or CVE catalog blob).
    ...
    if args.out_json:
        ...
        for cu in sorted_urls:
            ...
            rec = {
                ...
                "rxforge_integration": "suggested_integration",
